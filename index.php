<?php
/**
 * Page de connexion Ã  l'application
 * Affiche le formulaire de connexion et gÃ¨re les redirections et messages d'erreur
 */

// Inclure le fichier de configuration
require_once 'config/config.php';

// GÃ©nÃ©rer un token CSRF pour la sÃ©curitÃ© du formulaire
...
if (isset($_GET['expired']) && $_GET['expired'] == 1) {
    $error_message = "Votre session a expirÃ©. Veuillez vous reconnecter.";
}
if (isset($_SESSION['error_message'])) {
    $error_message = $_SESSION['error_message'];
    unset($_SESSION['error_message']); // Effacer le message aprÃ¨s utilisation
}
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    ...
    <script>
        ...
        // Afficher le message d'erreur en tant que notification si nÃ©cessaire
        ...
        window.addEventListener('load', function() {
            ...
            setTimeout(function() {
                ...
                // AprÃ¨s la transition de fondu du loader, le cacher complÃ¨tement
                setTimeout(function() {
